...
- Since you're now passing a parameter to loadMap(), you should probably give this function declaration a parameter... calling this variable *mapid* would make sense. Make sure to console.log *mapid* inside your loadMap() function to make sure it's getting passed in properly.
